...
{
    [TestFixture]
    public class When_a_Post_is_made_with_IfMatchNone_and_the_QuizResult_already_exists : Given_a_new_QuizResultsController
    {
        private QuizResult quizResult;

        public override void When()
        {
            this.Request.Headers.Add("If-None-Match", "*");
        ...
        [Test]
        public void Then_an_HttpResponseException_should_be_thrown_with_a_412_status_code()
        {
            this.TestException<HttpResponseException>(x => x.Response.StatusCode.Should().Be(HttpStatusCode.PreconditionFailed));
        }
