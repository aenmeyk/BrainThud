...
{
    [TestFixture]
    public class When_Delete_is_called : Given_a_new_NuggetController
    {
        private HttpResponseMessage response;

        public override void When()
        {
            this.response = this.NuggetsController.Delete(TestValues.ROW_KEY);
        }

        [Test]
        public void Then_Delete_is_called_on_the_NuggetRepository()
        {
            this.NuggetRepository.Verify(x => x.Delete(TestValues.ROW_KEY), Times.Once());
        }
